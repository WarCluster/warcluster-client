...
module.exports.prototype.send = function(mission) {
	...
	this.delta_x = this.mission.Target[0] - this.mission.Source[0];
	this.delta_y = this.mission.Target[1] - this.mission.Source[1];
...
module.exports.prototype.tick = function() {
	if (this.context.currentTime > this.endTime) {
		...
		this.position.x = this.mission.Source[0] + this.delta_x * this.progress;
		this.position.y = this.mission.Source[1] + this.delta_y * this.progress;
